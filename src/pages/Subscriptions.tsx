      ...
      <div className="relative pt-12 pb-8 overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          <div className="flex items-center gap-4">
            ...
            <p className="text-[10px] font-bold text-white/72 uppercase tracking-[0.5em]">Your Subscriptions</p>
          </div>
        ...
        <div className="text-center py-48 bg-white/[0.01] rounded-[64px] border border-white/[0.03] shadow-inner relative overflow-hidden group">
          ...
          <div className="flex flex-col items-center justify-center relative z-10">
            <div className="w-28 h-28 rounded-[40px] bg-white/[0.02] border border-white/[0.05] flex items-center justify-center mb-10 shadow-2xl">
              <CreditCard className="w-12 h-12 text-white/35" />
            </div>
            <h3 className="text-3xl font-display font-bold text-white mb-4">No Subscriptions Yet</h3>
            <p className="text-sm text-white/55 max-w-xs mx-auto leading-relaxed">Add your recurring payments like Netflix, Spotify, or rent.</p>
          </div>
        </div>
      ) : (
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-12">
                  <div className="flex items-center gap-8">
                    <div className="w-20 h-20 rounded-[32px] bg-white/[0.02] border border-white/[0.05] flex items-center justify-center text-white/55 group-hover:text-blue-400 group-hover:bg-blue-500/10 group-hover:border-blue-500/20 transition-all duration-700 shadow-2xl">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 mt-2.5">
                        <span className="px-3 py-1 rounded-lg bg-white/[0.03] border border-white/[0.05] text-[10px] font-bold text-white/65 uppercase tracking-[0.2em]">
                          {sub.frequency}
                        </span>
                        <div className="w-2 h-2 rounded-full bg-blue-500 animate-pulse shadow-[0_0_10px_rgba(59,130,246,0.5)]" />
                        <span className="text-[11px] font-bold text-white/55 uppercase tracking-[0.3em]">Active</span>
                      </div>
                    </div>
                  </div>
                  <button 
                ...
                <div className="space-y-8">
                  <div className="flex justify-between items-end">
                    ...
                    <div className="text-right space-y-2">
                      <p className="text-[10px] font-bold text-white/45 uppercase tracking-[0.3em]">Billing</p>
                  ...
                  <div className="pt-8 border-t border-white/[0.03] flex justify-between items-center">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[11px] font-bold text-white/65 uppercase tracking-[0.4em]">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[11px] font-bold text-white/55 uppercase tracking-[0.4em] italic">Auto-renew</span>
                    </div>
                  </div>
                </div>
              </div>
